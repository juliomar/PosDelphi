...
type
  ...
  TRazerBladeStealth = class(TInterfacedObject, INotebook)
  private
    function BuscarNome: string;
    function BuscarTamanhoTela: string;
    function BuscarMemoriaRAM: string;
...
function TRazerBladeStealth.BuscarMemoriaRAM: string;
begin
  Result := '16GB DDR';
end;

function TRazerBladeStealth.BuscarNome: string;
begin
  Result := 'Blade Stealth' ;
end;

function TRazerBladeStealth.BuscarTamanhoTela: string;
begin
  Result := '12.5 polegadas' ;
