  ...
  try
    ...
    begin
      FProduct.Adicionar('<tr>');
		FProduct.Adicionar('<td class="col-xs-2">' + DataSet.FieldByName('Id').AsString + '</td>');
		FProduct.Adicionar('<td class="col-xs-2">' + DataSet.FieldByName('Nome').AsString + '</td>');
		FProduct.Adicionar('<td class="col-xs-2">' + DataSet.FieldByName('Sobrenome').AsString + '</td>');
		FProduct.Adicionar('<td class="col-xs-2">' + DataSet.FieldByName('Matricula').AsString + '</td>');
      FProduct.Adicionar('</tr>');
...
begin
  ...
  FProduct.Adicionar('<p class="text-center">Copiado na cara dura por: Felipe Rodrigues Pucci</p>');
